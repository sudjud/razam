...
import news2 from "@/assets/images/news/illumination.jpg";
import news4 from "@/assets/images/news/ideas.jpg";
import { ref } from "vue";
...
const news = [
  {
    ...
    title: "Реализованный проект: офис с видом на море",
    by: "Admin",
    date: "2 Ноября 2024",
  },
  {
    photo: news2,
    category: "Интерьер и освещение",
    title: "Как освещение меняет атмосферу интерьера",
    by: "Admin",
    date: "2 Ноября 2024",
  },
  {
    photo: news4,
    category: "Ремонт и декор",
    title: "Идеи для стильного ремонта",
    by: "Admin",
    date: "2 Ноября 2024",
  },
  {
    photo: news2,
    category: "Тренды дизайна",
    title: "Тренды в дизайне: что актуально",
    by: "Admin",
    date: "2 Ноября 2024",
  },
];
