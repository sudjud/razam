<template>
  <main>
    <p>Главная / Блог</p>
    <h1>
      <span class="wow reveal-bb" ref="articlesSection">Блог</span>
    </h1>
  </main>
  ...
  <div class="pagination">
    <button @click="prevPage" :disabled="currentPage === 1">
      <img src="@/assets/images/blog/left-arrow.svg" alt="" />
    </button>
    <div
    ...
    <button @click="nextPage" :disabled="currentPage === totalPages">
      <img src="@/assets/images/blog/right-arrow.svg" alt="" />
    </button>
  </div>
</template>
...
const paginatedBlog = computed(() => {
  ...
  return blog.slice(start, start + itemsPerPage);
});
